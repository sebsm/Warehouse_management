# Generated by Django 3.1 on 2020-08-14 11:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('F', 'Fruits'), ('V', 'Vegetables'), ('D', 'Dairy'), ('M', 'Meat'), ('B', 'Beverages')], max_length=2)),
                ('label', models.CharField(choices=[('P', 'Primary'), ('S', 'Secondary'), ('D', 'Danger')], max_length=1)),
                ('slug', models.SlugField()),
                ('description', models.TextField()),
                ('image', models.ImageField(upload_to=django.core.files.storage.FileSystemStorage(location='/media/photos'))),
            ],
        ),
        migrations.CreateModel(
            name='Order',
